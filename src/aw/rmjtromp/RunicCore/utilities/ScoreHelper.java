 ...
 *
 * @author crisdev333
 * @website https://www.spigotmc.org/threads/create-scoreboards-in-a-simple-way.272337/
 *
 */
public class ScoreHelper {
    ...
    public static boolean hasScore(RunicPlayer player) {
        return players.containsKey(player.getUniqueId());
    }
    ...
    public static ScoreHelper createScore(RunicPlayer player) {
        return new ScoreHelper(player.getPlayer());
    }
    ...
    public static ScoreHelper getByPlayer(RunicPlayer player) {
        return players.get(player.getUniqueId());
    }
    ...
    public static ScoreHelper removeScore(RunicPlayer player) {
        return players.remove(player.getUniqueId());
    }
