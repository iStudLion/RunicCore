...
public class BukkitPlayer extends RunicOfflinePlayer implements Player {

	protected Player player;
	
	protected BukkitPlayer(Player player) {
		super(player.getUniqueId());
		this.player = super.player.getPlayer();
		System.out.print(player != null ? player : "player is null");
		System.out.print(this.player != null ? this.player : "player is null");
	}
	...
	public Block getTargetBlock(Set<Material> arg0, int arg1) {
		return getTargetBlock(arg0, arg1);
	}
	...
	public void sendMessage(String arg0) {
		this.player.sendMessage(ChatColor.translateAlternateColorCodes('&', arg0));
	}
	...
	public void setSneaking(boolean arg0) {
		this.player.setSneaking(arg0);this.player.setSneaking(arg0);
	}

	@Override
	public void setSpectatorTarget(Entity arg0) {
		this.player.setSpectatorTarget(arg0);this.player.setSpectatorTarget(arg0);
	}

	@Override
	public void setSprinting(boolean arg0) {
		this.player.setSprinting(arg0);this.player.setSprinting(arg0);
	}
	...
	public void setTexturePack(String arg0) {
		this.player.setTexturePack(arg0);this.player.setTexturePack(arg0);
	}

	@Override
	public void setTotalExperience(int arg0) {
		this.player.setTotalExperience(arg0);this.player.setTotalExperience(arg0);
	}
	...
	public void showPlayer(Player arg0) {
		this.player.showPlayer(arg0);this.player.showPlayer(arg0);
	}
	...
	public boolean equals(Object object) {
		if(object instanceof BukkitPlayer) {
			return this.player.equals(((BukkitPlayer) object).getPlayer());
		} else return this.player.equals(object);
	}
